...
argp.add_argument("--root-module", default="github.com/zeiss/v8go")
...
def generate_imported_mod_file(path, root_module, os, arch, min_go_version):
    with open(path, "wt") as f:
        f.write(IMPORTED_MOD_TMPL.format(root=root_module,
                os=os, arch=arch, min_go_version=min_go_version))
